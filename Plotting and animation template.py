...
plt.rcParams['animation.ffmpeg_path'] = 'D:\\OneDrive\\DeskCont\\JordansStuff\\PythonDir\\Dependencies\\ffmpeg\\bin\\ffmpeg.exe'
...
p1=plt.figure(300)
r=0
with Vid.saving(p1, "D:\\OneDrive\\DeskCont\\JordansStuff\\PythonDir\\test3.mp4",300):
